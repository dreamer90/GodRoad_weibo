...
class VisitorView: UIView {
    ...
    private lazy var loginButton :UIButton = {
       ...
       btn.setBackgroundImage(UIImage(named:"common_button_white_disable"), forState: UIControlState.Normal)
        btn.addTarget(self, action: #selector(VisitorViewDelegate.loginBtnWillClick), forControlEvents: UIControlEvents.TouchUpInside)
    ...
    private lazy var registerButton: UIButton = {
        ...
        btn.addTarget(self, action: #selector(VisitorViewDelegate.registerBtnWillClick), forControlEvents: UIControlEvents.TouchUpInside)
        return btn
    }()
